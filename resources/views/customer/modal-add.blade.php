            ...
            <form action="{{ route('customer.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama" required placeholder="Nama perusahaan"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="bidang" placeholder="Contoh: Konstruksi"
                                class="w-full pl-11 pr-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 focus:bg-white focus:border-red-500 focus:ring-2 focus:ring-red-500/20 focus:outline-none text-sm transition-all">
                        </div>
                    </div>
                    <div class="space-y-1.5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="emailid" placeholder="email@perusahaan.com"
                                class="w-full pl-11 pr-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 focus:bg-white focus:border-red-500 focus:ring-2 focus:ring-red-500/20 focus:outline-none text-sm transition-all">
                        </div>
                    </div>
                </div>
