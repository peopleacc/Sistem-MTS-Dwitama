...
<div id="editProjectModal" class="fixed inset-0 z-50 hidden">
    <div class="absolute inset-0 bg-black/50 backdrop-blur-sm transition-opacity" onclick="closeEditProjectModal()"></div>
            ...
            <form action="#" id="editProjectForm" method="POST" class="p-6 space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="edit_project_name" name="project_name" required placeholder="Nama project"
